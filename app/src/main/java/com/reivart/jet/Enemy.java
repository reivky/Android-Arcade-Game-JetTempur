...
import static com.reivart.jet.GameView.ENEMY_DESTROYED;
import static com.reivart.jet.GameView.SCORE;
...
public class Enemy {
    ...
    public Enemy(Context context, int screenSizeX, int screenSizeY, SoundPlayer soundPlayer) {
        ...
        mEnemies = new int[]{R.drawable.musuh, R.drawable.musuh, R.drawable.musuh};
